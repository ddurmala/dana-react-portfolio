// import gitHub_img from '../images/github-icon.png'
...
function Footer() {
    return (
        ...
        <div className="footer d-flex justify-content-center py-4">
            <p className="footer-text align-self-end">Find me at: </p>
            <a href="https://github.com/ddurmala" target="_blank">
            ...
            <a href="https://www.linkedin.com/in/dana-castagna-5432522a4" target="_blank">
